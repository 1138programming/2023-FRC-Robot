...
public class AutoScoreHighAndFlipWrist extends SequentialCommandGroup {
  /** Creates a new AutoScoreHighAndFlipWrist. */
  Scoring scoring;
  public AutoScoreHighAndFlipWrist(Scoring scoring) {
    this.scoring = scoring;
    
    addCommands(
      new ParallelCommandGroup( 
        new MoveLiftToPos(scoring, KLiftHighPos),
