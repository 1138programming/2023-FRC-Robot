...
package frc.robot.CommandGroups.Auton.CubeOnly;

import edu.wpi.first.wpilibj2.command.ParallelDeadlineGroup;
import edu.wpi.first.wpilibj2.command.ParallelRaceGroup;
import edu.wpi.first.wpilibj2.command.SequentialCommandGroup;
import edu.wpi.first.wpilibj2.command.WaitCommand;
import frc.robot.CommandGroups.Auton.AutoBalanceBackwardsSequence;
...
public class CubeHighBalanceMobility extends SequentialCommandGroup {
  /** Creates a new ConeHighLeave. */
  public CubeHighBalanceMobility(Base base, Intake intake, Limelight limelight, Lift lift) {
