...
public class ConeHighBalanceMobility extends SequentialCommandGroup {
  /** Creates a new ConeHighLeave. */
  public ConeHighBalanceMobility(Base base, Intake intake, Limelight limelight, Lift lift) {
