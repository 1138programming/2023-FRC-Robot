...
import frc.robot.CommandGroups.Auton.ConeOnly.ConeHigh;
...
public class OpenSideConeHighCubeLowBlue extends SequentialCommandGroup {
  /** Creates a new ConeHighLeave. */
  public OpenSideConeHighCubeLowBlue(Base base, Intake intake, Limelight limelight, Lift lift) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new DriveToPose(base, KOpenSideCubePickupBlue),
        new IntakeSwivelAndCollect(intake),
        new WaitCommand(4)
      ),
      new ParallelRaceGroup(
        new DriveToPose(base, KOpenSideBackToCommunityBlue),
        new IntakeSwivelTop(intake),
        // new IntakeUpAuton(intake, 3),
        new WaitCommand(3)
      ),
      new ParallelRaceGroup(
        new DriveToPose(base, KOpenSideShootPositionBlue),
