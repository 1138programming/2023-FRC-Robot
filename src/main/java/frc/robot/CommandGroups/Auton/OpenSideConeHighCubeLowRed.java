...
public class OpenSideConeHighCubeLowRed extends SequentialCommandGroup {
  /** Creates a new ConeHighLeave. */
  public OpenSideConeHighCubeLowRed(Base base, Intake intake, Limelight limelight, Lift lift) {
